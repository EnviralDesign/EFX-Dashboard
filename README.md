...
https://github.com/EnviralDesign/EFX-Dashboard/releases/download/v0.1.0/efx.dashboard.build.549.zip
...
#### Magic String (Optional, but recommended)

![alt text](./media/image-15.png)

When you setup EFX publisher, there are a number of parameters that are used in combination to generate the unique hash identifier.
